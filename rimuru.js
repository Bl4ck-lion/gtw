...
try {
    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam1?apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam2?apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam3?apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam4?apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam5?apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam6?apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam7?apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam8?apikey=apikey=79c4683acff3cb4fbddbc08a&nomor=${args[1]}`)
    reply("Success")
               } catch (err) {
            sendMess(ownerNumber, `${command} Error:` + err)
            reply(mess.error.api)
...
case 'kemonomimi':
case 'nsfw_avatar':
var _0x55a914=_0x16ea;function _0x32b5(){var _0x46c4a8=['16AAKHPI','➡️Next','5144472NeVSrr','follow\x20ʜᴀɴɴ࿐\x20https://instagram/mr.lucifer086/','41198FVMgia','imageMessage','22ooANWN','4ORJysO','prepareMessageMedia','3554830dxIixu','8482866JLpwTk','3355260xinDbg','©WhatsApp\x20bot','4222799iTzQWE','745146yDJRMB','https://api.lolhuman.xyz/api/random2/','prepareMessageFromContent','81sBGLdn'];_0x32b5=function(){return _0x46c4a8;};return _0x32b5();}function _0x16ea(_0x2b7daa,_0x358efa){var _0x32b50d=_0x32b5();return _0x16ea=function(_0x16ea56,_0x35be70){_0x16ea56=_0x16ea56-0x1f2;var _0x2fbffb=_0x32b50d[_0x16ea56];return _0x2fbffb;},_0x16ea(_0x2b7daa,_0x358efa);}(function(_0x19f5b4,_0x526ac6){var _0xca7a9a=_0x16ea,_0x433895=_0x19f5b4();while(!![]){try{var _0x3ff244=parseInt(_0xca7a9a(0x201))/0x1+-parseInt(_0xca7a9a(0x1f7))/0x2*(-parseInt(_0xca7a9a(0x1f2))/0x3)+-parseInt(_0xca7a9a(0x1fa))/0x4*(parseInt(_0xca7a9a(0x1fc))/0x5)+parseInt(_0xca7a9a(0x1fd))/0x6+-parseInt(_0xca7a9a(0x200))/0x7*(parseInt(_0xca7a9a(0x1f3))/0x8)+-parseInt(_0xca7a9a(0x1f5))/0x9+-parseInt(_0xca7a9a(0x1fe))/0xa*(-parseInt(_0xca7a9a(0x1f9))/0xb);if(_0x3ff244===_0x526ac6)break;else _0x433895['push'](_0x433895['shift']());}catch(_0x4bb046){_0x433895['push'](_0x433895['shift']());}}}(_0x32b5,0xdb046),reply(mess['wait']),buff=await getBuffer(_0x55a914(0x202)+command+'?apikey=79c4683acff3cb4fbddbc08a'),buttons=[{'buttonId':''+(prefix+command),'buttonText':{'displayText':_0x55a914(0x1f4)},'type':0x1}],imageMsg=(await rimuru[_0x55a914(0x1fb)](buff,'imageMessage',{'thumbnail':buff}))[_0x55a914(0x1f8)],buttonsMessage={'footerText':_0x55a914(0x1f6),'imageMessage':imageMsg,'contentText':_0x55a914(0x1ff),'buttons':buttons,'headerType':0x4},prep=await rimuru[_0x55a914(0x203)](from,{'buttonsMessage':buttonsMessage},{'quoted':freply}),rimuru['relayWAMessage'](prep));
    break           
...
// Islami //
case 'listsurah':
    get_result = await fetchJson(`https://api.lolhuman.xyz/api/quran?apikey=79c4683acff3cb4fbddbc08a`)
    get_result = get_result.result
    ini_txt = 'List Surah:\n'
...
case 'kisahnabi':
    ...
    query = args.join(" ")
    get_result = await fetchJson(`https://api.lolhuman.xyz/api/kisahnabi/${query}?apikey=79c4683acff3cb4fbddbc08a`)
    get_result = get_result.result
...
case 'jadwalsholat':
    ...
    daerah = args.join(" ")
    get_result = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${daerah}?apikey=79c4683acff3cb4fbddbc08a`)
    get_result = get_result.result
...
[ ${args[0]} ] Ketik Y/N untuk menerima atau menolak permainan`
   ...
   sendButMessage(from, titid, `Klik Untuk Ke Game Selanjutnya`, [
       ...
       case 'tebakkata':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/kata?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.jawaban
       ...
       case 'tebaklirik':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/lirik?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
      ...
      case 'tebakjenaka':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/jenaka?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
       ...
       case 'kimiakuis':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/unsurkimia?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
       ...
       case 'tebakbendera':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/bendera?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
       ...
       case 'susunkata':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/susunkata?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              pertanyaan = get_result.pertanyaan
       ...
       case 'asahotak':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/asahotak?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.pertanyaan
       ...
       case 'caklontong':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/caklontong2?apikey=79c4683acff3cb4fbddbc08a`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
...
rimuru.sendMessage(from, {url: anu.result.audio } , audio, { mimetype: Mimetype.mp4Audio, quoted: freply })
      ...
      case 'kusonime':
       ...
       case 'storyanime':
              ...
              reply(mess.wait)
              anu = await fetchJson(`https://lolhuman.herokuapp.com/api/storynime?apikey=79c4683acff3cb4fbddbc08a`)
...
//------------------< Stalk >-------------------
      ...
      case 'githubstalk':
              ...
              reply(mess.wait)
              username = args[0]
              ini_result = await fetchJson(`https://api.lolhuman.xyz/api/github/${username}?apikey=79c4683acff3cb4fbddbc08a`)
...
`
      ...
      case 'igstalk':
             ...
             reply(mess.wait)
             username = args[0]
             ini_result = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${username}?apikey=79c4683acff3cb4fbddbc08a`)
             ini_result = ini_result.result
...
`
      ...
      case 'tiktokstalk':
             ...
             reply(mess.wait)
             stalk_toktok = args[0]
             get_result = await fetchJson(`http://lolhuman.herokuapp.com/api/stalktiktok/${stalk_toktok}?apikey=79c4683acff3cb4fbddbc08a`)
             get_result = get_result.result
...
//------------------< Sticker/Tools >-------------------
      ...
      case 'doge':
       ...
       case 'telestiker':
              ...
              reply(mess.wait)
              ini_url = await fetchJson(`https://api.lolhuman.xyz/api/telestick?apikey=79c4683acff3cb4fbddbc08a&url=${args[0]}`)
       ...
       case 'emoji':
              ...
              ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji/${emoji}?apikey=79c4683acff3cb4fbddbc08a`)
       ...
       case 'emoji2':
              ...
              ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji3/${emoji}?apikey=79c4683acff3cb4fbddbc08a`)
              await rimuru.sendMessage(from, ini_buffer, sticker, { quoted: freply })
 case 'ttp':
                case 'ttp2':
                case 'ttp3':
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
anu1 = await getBuffer (`https://api.zeks.xyz/api/burning-image?apikey=79c4683acff3cb4fbddbc08a&image=${tolink}`)
...
rano = getRandom('.webp')
              ...
              pjr = await getBuffer(`https://api.zeks.xyz/api/burning-image?apikey=79c4683acff3cb4fbddbc08a&image${encodeURI(tolink)}`)
...
ranp = getRandom('.gif')
rano = getRandom('.webp')
anu1 = `https://api.lolhuman.xyz/api/editor/triggered?apikey=79c4683acff3cb4fbddbc08a&img=${tolink}`
sendStickerUrl(from, `${anu1}`)
...
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/editor/triggered?apikey=79c4683acff3cb4fbddbc08a&img=${ini_url}`)
...
let ane = await getBuffer(`https://api.zeks.xyz/api/burning-image?apikey=79c4683acff3cb4fbddbc08a&image=${tolink}`)
...
break 
   ...
   case 'tiger':
     ...
     ranp = getRandom('.gif')
     rano = getRandom('.webp')
     var ini_buffer = `https://api.lolhuman.xyz/api/editor/triggered?apikey=79c4683acff3cb4fbddbc08a&img=${tolink}`
...
let ane = await getBuffer(`https://api.lolhuman.xyz/api/attp?apikey=79c4683acff3cb4fbddbc08a&text=${mek}`)
...
█████████
 ██ ██\n`
       ...
       case 'sc': 
       case 'src':
              textImg(`ʙᴏᴛ ɪɴɪ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ sᴄ ᴅᴀʀɪ ʏᴏᴜ ᴛᴜʙᴇ : MAU NGAPAIN OM?CARI SC KAH `)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Menunya Bang:v >-------------------
         case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/denarabot/`)
             break
      case 'grub':
             reply('https://chat.whatsapp.com/LL69TwtWnDGIsQhpfPEpfC')
             break
...
if (budy.includes(`syalom`)) {
 ...
 if (budy.includes(`Hann`)) {
  reply(`ᴀᴜᴛᴏ ʀᴇsᴘᴏɴ: ɪʏᴀ ᴋᴇɴᴀᴘᴀ ʏᴀ ᴋᴀᴋ ᴍᴀɴɢɢɪʟ-ᴍᴀɴɢɢɪʟ ʜᴀɴɴ?`)
rimuru.updatePresence(from, Presence.composing)
